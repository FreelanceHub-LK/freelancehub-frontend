...
export default function ProjectDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        <Link href="/projects" className="inline-flex items-center gap-2 text-gray-600 hover:text-gray-900 px-3 py-2 text-sm rounded-md bg-gray-100 hover:bg-gray-200 transition-colors">
          <ArrowLeft size={16} />
          Back to Projects
        </Link>
      </div>
