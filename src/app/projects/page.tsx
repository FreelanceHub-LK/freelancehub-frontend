...
const mockProjects: Array<{
  ...
  },
  {
    ...
    description:
      "Need an experienced marketer to run social media campaigns for our new product launch. Campaign includes content creation, scheduling, and performance analysis.",
    budget: 75000,
    deadline: "2025-05-15",
