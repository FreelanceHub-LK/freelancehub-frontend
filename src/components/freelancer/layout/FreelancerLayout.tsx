...
const navigation = [
  ...
  { name: "My Contracts", href: "/freelancer/contracts", icon: FileText },
  { name: "Messages", href: "/freelancer/messages", icon: MessageCircle },
  { name: "Reviews", href: "/freelancer/reviews", icon: Star },
  { name: "Payments", href: "/freelancer/payments", icon: CreditCard },
