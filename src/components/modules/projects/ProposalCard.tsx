      ...
      <div className="flex items-start justify-between">
        <div className="flex items-center">
          <div className="h-12 w-12 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden">
            {freelancerAvatar ? (
              <img src={freelancerAvatar} alt={freelancerName} className="h-full w-full object-cover" />
            ) : (
          ...
          <div className="ml-3">
            ...
            <div className="flex items-center">
              ...
              <span className="ml-1 text-sm text-gray-500">{freelancerRating.toFixed(1)}</span>
            </div>
          </div>
        </div>
        <div className="text-right">
          <div className="font-medium text-green-600">LKR {proposedBudget.toLocaleString()}</div>
